    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $contentPage->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keywords') ? 'is-invalid' : '' }}" type="text" name="keywords" id="keywords" value="{{ old('keywords', $contentPage->keywords) }}" >
            ...
            <div class="form-group">
                ...
                <textarea class="form-control  {{ $errors->has('page_text') ? 'is-invalid' : '' }}" name="page_text" id="page_text">{!! old('page_text', $contentPage->page_text) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control  {{ $errors->has('page_text_ar') ? 'is-invalid' : '' }}" name="page_text_ar" id="page_text_ar">{!! old('page_text_ar', $contentPage->page_text_ar) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('excerpt_ar') ? 'is-invalid' : '' }}" name="excerpt_ar" id="excerpt_ar">{{ old('excerpt_ar', $contentPage->excerpt_ar) }}</textarea>
...
<script>
  ...
  Dropzone.options.imageDropzone = {
      ...
      init: function () {
          @if(isset($contentPage) && $contentPage->getMedia('featured_image'))
              var files =
                  {!! json_encode($contentPage->getMedia('featured_image')) !!}
              for (var i in files) {
                  var file = files[i];
