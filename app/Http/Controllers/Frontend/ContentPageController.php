...
class ContentPageController extends Controller
{
    ...
    public function store(StoreContentPageRequest $request)
    {
        ...
        foreach ($request->input('image', []) as $file) {
            $contentPage->addMedia(storage_path('tmp/uploads/' . basename($file)))->toMediaCollection('image');
        }
    ...
    {
        $contentPage=ContentPage::where('id',$id)->with(['categories', 'tags', 'media'])->get();

        $contentPage->load('categories', 'tags');

        return view('frontend.contentPages.page-details', compact('contentPage'));
    }
    public function show_projects($id)
    {
        ...
        return view('frontend.contentPages.our-projects', compact('contentPage'));
    }
